...
class ResNet(nn.Module):
    def __init__(self, num_blocks = [3, 4, 6, 3]):
        ...
        self.layer2 = self._make_layer(Bottleneck, 128, num_blocks[1], stride=1)
        self.layer3 = self._make_layer(Bottleneck, 256, num_blocks[2], stride=1)
        self.layer4 = self._make_layer(Bottleneck, 512, num_blocks[3], stride=1)
        self.proj = nn.Conv2d(in_channels=2048, out_channels=1, kernel_size=1)
